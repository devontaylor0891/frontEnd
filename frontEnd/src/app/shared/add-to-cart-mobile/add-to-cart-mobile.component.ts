...
@Component({
  selector: 'app-add-to-cart-mobile',
  templateUrl: './add-to-cart-mobile.component.html',
  styleUrls: ['./add-to-cart-mobile.component.scss']
})
export class AddToCartMobileComponent implements OnInit, OnChanges {
