...
export class AddScheduleModalComponent implements OnInit {
  ...
  public deadlineDateMoment: any = new Date(); // default is now because date is tomorrow, just for ease of coding
  public deadlineTimeMoment: any = new Date(0, 0, 0, (this.startTimeMoment.getHours() - 6), this.startTimeMoment.getMinutes(), 0, 0); // defaults to 12 hours before start time
  public deadlineDateTime: any;
  public deadlineDateTimeMin: any;
  ...
  onChooseDate() {
    ...
    this.schedMonth = this.dateMoment.getMonth();
    this.schedYear = this.dateMoment.getFullYear();
    // this.deadlineDateMoment = this.dateMoment; // set deadline date
    this.deadlineDateTimeMin = this.dateMoment;
    this.deadlineDateTime = this.dateMoment;
  };
  ...
  onChooseStartTime() {
    this.schedStartHour = this.startTimeMoment.getHours();
    this.schedStartMinute = this.startTimeMoment.getMinutes();
    this.deadlineTimeMoment = this.startTimeMoment;
    // this.deadlineTimeMoment.setHours(this.deadlineTimeMoment.getHours() - 6); // set deadline time to 6 hours before start time
    this.deadlineDateTimeMin = this.buildDate(this.dateMoment.getFullYear(), this.dateMoment.getMonth(), this.dateMoment.getDate(), this.startTimeMoment.getHours(), this.startTimeMoment.getMinutes());
  };
