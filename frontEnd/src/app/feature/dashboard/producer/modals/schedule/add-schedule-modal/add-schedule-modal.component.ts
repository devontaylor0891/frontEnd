...
export class AddScheduleModalComponent implements OnInit {
  ...
  buildRepeatSubmitArray() {
    ...
    console.log('array of scheds: ', this.repeatSubmitArray);
  };
  ...
  // new Date(Date.parse(otherISOStringDate) + (6.048e+8 * 2)).toISOString();
  // this returns a new isostring date two weeks in the future
