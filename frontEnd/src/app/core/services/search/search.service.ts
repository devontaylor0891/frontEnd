...
//       } else if (!this.findProducerId(pId, producers)) { //if the producer is not in the array, add them and their first product
...
//   findProducerId(id, producers) {
//     for (let i = 0; i < producers.length; i++) {
//       console.log(producers[i].id);
//       if (id === producers[i].id) {
//         return true;
//       }
//     }
//   }
...
// 			  let index = delivery.id;
// 			// see if the id is already in the deliveries array
// 			if (!deliveries.includes(index)) {
// 				//if not in the array, build the searchDelivery object
// 				let newDelivery = this.buildNewSearchDelivery(delivery, product); //here you'll need to get the producer info too
// 				//and push the delivery object into the deliveries array
