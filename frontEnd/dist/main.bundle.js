...
var AddProductComponent = /** @class */ (function () {
    function AddProductComponent(formBuild, location, producerService) {
        ...
        this.form = formBuild.group({
            ...
            'image': [''],
            'pricePerUnit': [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'unit': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'unitsPer': [1, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'category': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'subcategory': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'producerName': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'dateAdded': ['September 1, 2017'],
            'qtyAvailable': [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'qtyPending': [0],
            'qtyAccepted': [0],
            'qtyCompleted': [0],
            'isObsolete': ['false']
...
var ConsumerEditOrderModalComponent = /** @class */ (function () {
    ...
    ConsumerEditOrderModalComponent.prototype.buildForm = function () {
        ...
        this.orderForm = this.fb.group({
            consumerComment: [this.record.orderDetails.consumerComment, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]]
        });
...
var EditOrderModalComponent = /** @class */ (function () {
    ...
    EditOrderModalComponent.prototype.buildForm = function () {
        var _this = this;
        this.orderForm = this.fb.group({
            producerComment: [this.record.orderDetails.producerComment, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]]
        });
        // Subscribe to form value changes
...
var EditProductModalComponent = /** @class */ (function () {
    ...
    EditProductModalComponent.prototype.buildForm = function () {
        ...
        this.productForm = this.fb.group({
            name: [this.record.name, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]],
            description: [this.record.description, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]],
            image: [this.record.image, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]],
            pricePerUnit: [this.record.pricePerUnit, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]],
            unit: [this.record.unit, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]],
            unitsPer: [this.record.unitsPer, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]],
            category: [this.record.category, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]],
            subcategory: [this.record.subcategory, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]],
            qtyAvailable: [this.record.qtyAvailable, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]]
        });
        // Subscribe to form value changes
...
var AddScheduleModalComponent = /** @class */ (function () {
    function AddScheduleModalComponent(dashboardService, formBuild, activeModal, mapsAPILoader, ngZone) {
        ...
        this.form = formBuild.group({
            ...
            'description': [''],
            'repeat': [this.isRepeat, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'date': [this.dateMoment],
            'dates': [this.dateMoments],
            'startTime': [this.startTimeMoment, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'endTime': [this.endTimeMoment, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'deadlineCalcHours': [12],
            'deadlineDate': [this.deadlineDateMoment],
            'deadlineTime': [this.deadlineTimeMoment],
            'hasFee': [false, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'fee': [0],
            'hasWaiver': [false, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'feeWaiver': [0],
            'latitude': [null],
            'longitude': [null],
            'city': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            'address': [''],
            'province': ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required]
        });
    }
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* ViewChild */])("input2"),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* ElementRef */])
...
var EditScheduleModalComponent = /** @class */ (function () {
    ...
    EditScheduleModalComponent.prototype.buildForm = function () {
        ...
        this.scheduleForm = this.formBuild.group({
            ...
            date: [this.dateMoment, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            startTime: [this.startTimeMoment, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            endTime: [this.endTimeMoment, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            deadlineDate: [this.deadlineDateMoment, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            deadlineTime: [this.deadlineTimeMoment, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            hasFee: [this.record.hasFee, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
            fee: [this.record.fee],
            hasWaiver: [this.record.hasWaiver, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required],
...
var TableLayoutComponent = /** @class */ (function () {
    ...
    TableLayoutComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */],
            __WEBPACK_IMPORTED_MODULE_12__core_services_utility_utility_service__["a" /* UtilityService */]])
